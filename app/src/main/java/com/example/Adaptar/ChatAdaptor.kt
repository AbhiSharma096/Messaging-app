...
class ChatAdaptor(val context:Context,val messages: List<com.example.mesenger.Message>,senderRoom : String,receiverRoom: String):RecyclerView.Adapter <RecyclerView.ViewHolder?>(){
      ...
      override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            if (viewType == sent){
                  ...
                  val view = LayoutInflater.from(context).inflate(R.layout.sendgpt,parent,false)
            ...
            else
            {
                  ...
                  val view = LayoutInflater.from(context).inflate(R.layout.recievedgpt,parent,false)
